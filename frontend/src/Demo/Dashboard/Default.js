...
const Dashboard = (props) => {
    ...
    const { totalLearners,totalTrainers,totalCourses,totalUsers,totalUsersForDashboard,totalCoursesForDashboard,totalLearnerCoursesForDashboard,totalEnrollLearners,totalTrainerCoursesForDashboard } = useContext(UserDataContext);
    useEffect(() => {
        if(!loggedIn){
            ...
            <Row style={{ marginTop: '-35px' }}>
                ...
                {loggedInUser && !loggedInUser.is_admin && loggedInUser.is_staff && (
                    ...
                    <Col md={6} xl={4}>
                        <Card>
                            <Card.Body>
                                <h6 className='mb-4'>My Learners</h6>
                                <div className="row d-flex align-items-center">
                                    <div className="col-9">
                                        <h3 className="f-w-300 d-flex align-items-center m-b-0">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            ...
                                            {totalEnrollLearners && totalEnrollLearners.count}
                                        </h3>
                                    </div>
                                </div>
                                <div className="progress m-t-30" style={{height: '7px'}}>
                    ...
                    <Col md={6} xl={4}>
                        <Card>
                            <Card.Body>
                                <h6 className='mb-4'>My Courses</h6>
                                <div className="row d-flex align-items-center">
                                    <div className="col-9">
                                        <h3 className="f-w-300 d-flex align-items-center m-b-0">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            ...
                                            {totalTrainerCoursesForDashboard && totalTrainerCoursesForDashboard.count}
                                        </h3>
                                    </div>
                                </div>
                                <div className="progress m-t-30" style={{height: '7px'}}>
                ...
                <Col md={loggedInUser && loggedInUser.is_admin ? 6 : 12}>
                    <Card className='Recent-Users'>
                        <Card.Header>
                            <Card.Title as='h5'>Latest Courses</Card.Title>
                        </Card.Header>
                        <Card.Body className='px-0 py-2'>
                            <Table responsive hover>
                                <tbody>
